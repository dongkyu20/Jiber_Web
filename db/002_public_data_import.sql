...
CREATE TABLE IF NOT EXISTS public_data_import_errors (
    ...
    api_type ENUM('SALE', 'RENT', 'OFFICETEL_SALE', 'OFFICETEL_RENT', 'VILLA_SALE', 'VILLA_RENT') NULL,
...
CREATE TABLE IF NOT EXISTS public_data_raw_apartment_transactions (
    ...
    property_type ENUM('APARTMENT', 'OFFICETEL', 'VILLA', 'HOUSE') NOT NULL DEFAULT 'APARTMENT',
    ...
    KEY idx_public_data_raw_property_type (property_type, deal_date DESC),
